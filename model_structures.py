...
async def structure_fully_connected_3_9_3_qwen3_30b_a3b(query):
    model = "qwen/qwen3-30b-a3b"
...
async def structure_complete_tree_3_3_qwen3_30b_a3b(query):
    model = "qwen/qwen3-30b-a3b"
...
async def structure_compare_improved_5(query):
    model = "qwen/qwen3-30b-a3b"
    ...
    layer2_1 = Aggregator(model, query, [layer0_1, layer1_1, layer1_2, layer1_3])
    layer2_2 = Aggregator(model, query, [layer0_2, layer1_1, layer1_2, layer1_3])
    layer2_3 = Aggregator(model, query, [layer0_3, layer1_1, layer1_2, layer1_3])
...
async def structure_compare_improved_6(query):
    model = "qwen/qwen3-30b-a3b"
...
async def structure_compare_improved_7(query):
    model = "qwen/qwen3-30b-a3b"
    ...
    layer3_1 = Aggregator(model, query, [layer2_1, layer2_2, layer2_3, layer1_1, layer1_3, layer0_2])
...
async def structure_compare_improved_2_1(query):
    model = "qwen/qwen3-30b-a3b"
    ...
    layer1_1 = Aggregator(model, query, [layer0_1, layer0_2, layer0_3, layer0_4])
    layer1_2 = Aggregator(model, query, [layer0_1, layer0_2, layer0_3, layer0_4])
    layer1_3 = Aggregator(model, query, [layer0_1, layer0_2, layer0_3, layer0_4])
...
async def structure_compare_improved_2_2(query):
    model = "qwen/qwen3-30b-a3b"
    ...
    layer3_1 = Aggregator(model, query, [layer2_1, layer2_2, layer1_2])
...
async def structure_compare_improved_2_3(query):
    model = "qwen/qwen3-30b-a3b"
    ...
    layer3_1 = Aggregator(model, query, [layer2_1, layer2_2, layer1_1, layer1_3])
...
async def structure_compare_improved_2_4(query):
    model = "qwen/qwen3-30b-a3b"
    ...
    layer1_1 = Aggregator(model, query, [layer0_2, layer0_3, layer0_4])
    layer1_2 = Aggregator(model, query, [layer0_1, layer0_2, layer0_3, layer0_4])
    layer1_3 = Aggregator(model, query, [layer0_1, layer0_2, layer0_3])
    ...
    layer3_1 = Aggregator(model, query, [layer2_1, layer2_2, layer1_1, layer1_3, layer0_1, layer0_4])
...
async def structure_compare_improved_2_5(query):
    model = "qwen/qwen3-30b-a3b"
    ...
    layer1_1 = Aggregator(model, query, [layer0_3, layer0_4])
    layer1_2 = Aggregator(model, query, [layer0_1, layer0_2, layer0_3, layer0_4])
    layer1_3 = Aggregator(model, query, [layer0_1, layer0_2])

    layer2_1 = Aggregator(model, query, [layer1_2, layer1_3, layer0_2])
    layer2_2 = Aggregator(model, query, [layer1_1, layer1_2, layer0_3])
...
async def structure_compare_improved_2_6(query):
    model = "qwen/qwen3-30b-a3b"
    ...
    layer1_1 = Aggregator(model, query, [layer0_2, layer0_3, layer0_4])
    layer1_2 = Aggregator(model, query, [layer0_1, layer0_4])
    layer1_3 = Aggregator(model, query, [layer0_1, layer0_2, layer0_3])
...
async def structure_compare_improved_3_1(query):
    model = "qwen/qwen3-30b-a3b"
    ...
    layer2_1 = Aggregator(model, query, [layer0_1, layer0_2, layer0_3, layer1_1, layer1_2, layer1_3])
...
async def structure_new_chain_1(query):
    ...
    result = await layer1_1.generate()
...
async def structure_new_star_2(query):
    model = "qwen/qwen3-30b-a3b"
...
async def structure_new_star_3(query):
    model = "qwen/qwen3-30b-a3b"
...
async def structure_new_star_4(query):
    model = "qwen/qwen3-30b-a3b"
...
async def structure_new_star_5(query):
    model = "qwen/qwen3-30b-a3b"
...
async def structure_new_star_6(query):
    model = "qwen/qwen3-30b-a3b"
...
async def structure_new_refine_1(query):
    model = "qwen/qwen3-30b-a3b"

    layer0_1 = Proposer(model, query)

    layer1_1 = Refiner(model, query, [layer0_1])
...
async def structure_new_refine_2(query):
    model = "qwen/qwen3-30b-a3b"
    ...
    layer2_1 = Refiner(model, query, [layer1_1])
...
async def structure_new_refine_3(query):
    model = "qwen/qwen3-30b-a3b"
    ...
    layer3_1 = Refiner(model, query, [layer2_1])
...
async def structure_new_refine_4(query):
    model = "qwen/qwen3-30b-a3b"
    ...
    layer4_1 = Refiner(model, query, [layer3_1])
...
async def structure_new_refine_5(query):
    model = "qwen/qwen3-30b-a3b"
    ...
    layer5_1 = Refiner(model, query, [layer4_1])
...
async def structure_new_refine_6(query):
    model = "qwen/qwen3-30b-a3b"
    ...
    layer6_1 = Refiner(model, query, [layer5_1])
